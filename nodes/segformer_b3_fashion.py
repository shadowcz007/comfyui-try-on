...
class segformer_b3_fashion:
    ...
    def INPUT_TYPES(cls):
        return {"required":
                {     
                "image":("IMAGE",), 
               "shirt": ("BOOLEAN", {"default": True, "label_on": "✔ 衬衫、罩衫", "label_off": "× 衬衫、罩衫"}),
                "top": ("BOOLEAN", {"default": True, "label_on": "✔ 上衣、t恤", "label_off": "× 上衣、t恤"}),
                "sweater": ("BOOLEAN", {"default": True, "label_on": "✔ 毛衣", "label_off": "× 毛衣"}),
                "cardigan": ("BOOLEAN", {"default": True, "label_on": "✔ 开襟羊毛衫", "label_off": "× 开襟羊毛衫"}),
                "jacket": ("BOOLEAN", {"default": True, "label_on": "✔ 夹克", "label_off": "× 夹克"}),
                "vest": ("BOOLEAN", {"default": True, "label_on": "✔ 背心", "label_off": "× 背心"}),
                "pants": ("BOOLEAN", {"default": True, "label_on": "✔ 裤子", "label_off": "× 裤子"}),
                "shorts": ("BOOLEAN", {"default": True, "label_on": "✔ 短裤", "label_off": "× 短裤"}),
                "skirt": ("BOOLEAN", {"default": True, "label_on": "✔ 裙子", "label_off": "× 裙子"}),
                "coat": ("BOOLEAN", {"default": True, "label_on": "✔ 外套", "label_off": "× 外套"}),
                "dress": ("BOOLEAN", {"default": True, "label_on": "✔ 连衣裙", "label_off": "× 连衣裙"}),
                "jumpsuit": ("BOOLEAN", {"default": True, "label_on": "✔ 连身裤", "label_off": "× 连身裤"}),
                "cape": ("BOOLEAN", {"default": True, "label_on": "✔ 斗篷", "label_off": "× 斗篷"}),
                "glasses": ("BOOLEAN", {"default": True, "label_on": "✔ 眼镜", "label_off": "× 眼镜"}),
                "hat": ("BOOLEAN", {"default": True, "label_on": "✔ 帽子", "label_off": "× 帽子"}),
                "hairaccessory": ("BOOLEAN", {"default": True, "label_on": "✔ 头带", "label_off": "× 头带"}),
                "tie": ("BOOLEAN", {"default": True, "label_on": "✔ 领带", "label_off": "× 领带"}),
                "glove": ("BOOLEAN", {"default": True, "label_on": "✔ 手套", "label_off": "× 手套"}),
                "watch": ("BOOLEAN", {"default": True, "label_on": "✔ 手表", "label_off": "× 手表"}),
                "belt": ("BOOLEAN", {"default": True, "label_on": "✔ 皮带", "label_off": "× 皮带"}),
                "legwarmer": ("BOOLEAN", {"default": True, "label_on": "✔ 暖腿器", "label_off": "× 暖腿器"}),
                "tights": ("BOOLEAN", {"default": True, "label_on": "✔ 紧身衣、长筒袜", "label_off": "× 紧身衣、长筒袜"}),
                "sock": ("BOOLEAN", {"default": True, "label_on": "✔ 袜子", "label_off": "× 袜子"}),
                "shoe": ("BOOLEAN", {"default": True, "label_on": "✔ 鞋子", "label_off": "× 鞋子"}),
                "bagwallet": ("BOOLEAN", {"default": True, "label_on": "✔ 包、钱包", "label_off": "× 包、钱包"}),
                "scarf": ("BOOLEAN", {"default": True, "label_on": "✔ 围巾", "label_off": "× 围巾"}),
                "umbrella": ("BOOLEAN", {"default": True, "label_on": "✔ 雨伞", "label_off": "× 雨伞"}),
                "hood": ("BOOLEAN", {"default": True, "label_on": "✔ 兜帽", "label_off": "× 兜帽"}),
                "collar": ("BOOLEAN", {"default": True, "label_on": "✔ 衣领", "label_off": "× 衣领"}),
                "lapel": ("BOOLEAN", {"default": True, "label_on": "✔ 翻领", "label_off": "× 翻领"}),
                "epaulette": ("BOOLEAN", {"default": True, "label_on": "✔ 肩章", "label_off": "× 肩章"}),
                "sleeve": ("BOOLEAN", {"default": True, "label_on": "✔ 袖子", "label_off": "× 袖子"}),
                "pocket": ("BOOLEAN", {"default": True, "label_on": "✔ 口袋", "label_off": "× 口袋"}),
                "neckline": ("BOOLEAN", {"default": True, "label_on": "✔ 领口", "label_off": "× 领口"}),
                "buckle": ("BOOLEAN", {"default": True, "label_on": "✔ 带扣", "label_off": "× 带扣"}),
                "zipper": ("BOOLEAN", {"default": True, "label_on": "✔ 拉链", "label_off": "× 拉链"}),
                "applique": ("BOOLEAN", {"default": True, "label_on": "✔ 贴花", "label_off": "× 贴花"}),
                "bead": ("BOOLEAN", {"default": True, "label_on": "✔ 珠子", "label_off": "× 珠子"}),
                "bow": ("BOOLEAN", {"default": True, "label_on": "✔ 蝴蝶结", "label_off": "× 蝴蝶结"}),
                "flower": ("BOOLEAN", {"default": True, "label_on": "✔ 花", "label_off": "× 花"}),
                "fringe": ("BOOLEAN", {"default": True, "label_on": "✔ 额前短垂发", "label_off": "× 额前短垂发"}),
                "ribbon": ("BOOLEAN", {"default": True, "label_on": "✔ 丝带", "label_off": "× 丝带"}),
                "rivet": ("BOOLEAN", {"default": True, "label_on": "✔ 铆钉", "label_off": "× 铆钉"}),
                "ruffle": ("BOOLEAN", {"default": True, "label_on": "✔ 褶饰", "label_off": "× 褶饰"}),
                "sequin": ("BOOLEAN", {"default": True, "label_on": "✔ 亮片", "label_off": "× 亮片"}),
                "tassel": ("BOOLEAN", {"default": True, "label_on": "✔ 流苏", "label_off": "× 流苏"})
